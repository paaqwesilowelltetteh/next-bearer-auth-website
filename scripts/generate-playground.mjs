...
const filePath = '/Users/agrocenta/Sites/Nuxt/nuxt-bearer-auth-website/components/playground/PlaygroundSim.vue'
...
console.log('Successfully wrote PlaygroundSim.vue')
